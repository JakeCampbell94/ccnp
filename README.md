...
Study notes for the ENARSI exam and links to YouTube resources on the topics
...
- 2.1 Describe MPLS operations (LSR, LDP, label switching, LSP) - [INE MPLS Basics](https://www.youtube.com/watch?v=mMu4iPWI1m8)
- 2.2 Describe MPLS Layer 3 VPN
- 2.3 Configure and verify DMVPN (single hub) - [INE DMVPN Overview](https://www.youtube.com/watch?v=bCSVKWFLgYs)
  * 2.3.a GRE/mGRE
  * 2.3.b NHRP
  * 2.3.c IPsec
